...
mod sphere_multi_intersection_tests {
    ...
    fn the_hit_is_always_the_lowest_non_negative_intersection() {
        let sphere1 = Shape::new_sphere().to_shape2();
        let sphere2 = Shape::new_sphere().to_shape2();
        let sphere3 = Shape::new_sphere().to_shape2();
        let sphere4 = Shape::new_sphere().to_shape2();
        let intersections = Intersections::new(vec![
...
mod sphere_intersection_of_transformed_sphere_tests {
    ...
    fn intersect_scaled_sphere() {
        let sphere = Shape::new_sphere_transformed(Matrix4x4::scale(2., 2., 2.)).to_shape2();
    ...
    fn intersect_translated_sphere() {
        let sphere = Shape::new_sphere_transformed(Matrix4x4::translation(5., 0., 0.)).to_shape2();
        let ray = ray!((0., 0., -5.), (0., 0., 1.));
        let intersections = sphere.intersect(ray);
        assert_eq!(intersections.len(), 0);
    }
...
mod sphere_normal_tests {
    ...
    fn normal_of_translated_sphere() {
        let sphere = Shape::new_sphere_transformed(Matrix4x4::translation(0., 1., 0.)).to_shape2();
        assert_vector!(
